...
import { Card, CardContent, Badge, Button, Input, EmptyState, Pagination, Skeleton } from '@/components/ui';
              ...
              <div className="hidden sm:flex items-center border border-border-medium rounded-md">
                <button
                  ...
                  className={cn(
                    ...
                    viewMode === 'grid' ? 'bg-primary text-white' : 'hover:bg-light'
                  )}
                ...
                <button
                  ...
                  className={cn(
                    ...
                    viewMode === 'list' ? 'bg-primary text-white' : 'hover:bg-light'
                  )}
            ...
            <EmptyState
              ...
              description={
                hasActiveFilters
                  ...
                  : 'Documents will be published here once available'
              }
              action={
                hasActiveFilters && (
