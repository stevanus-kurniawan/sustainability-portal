import { MessageSquareWarning, Calendar, AlertCircle, CheckCircle, Clock } from 'lucide-react';
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            {grievance.attributes.publicSummary && (
              <p className="text-sm text-charcoal mb-3">{grievance.attributes.publicSummary}</p>
            )}
