import { GitBranch, Factory, Truck, MapPin, Calendar, FileCheck } from 'lucide-react';
                ...
                <CardContent className="p-5">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-medium text-charcoal mb-1 truncate">{entity.attributes.name}</h3>
                      <div className="space-y-1 text-sm text-steel">
                        <Badge variant="outline" className="text-xs">
                          {entity.attributes.entityType}
                        </Badge>
                        {entity.attributes.code && <p className="truncate">Code: {entity.attributes.code}</p>}
              ...
              <Card key={record.id} hover>
                <CardContent className="p-5">
                  <div className="flex items-center gap-4">
                    ...
                    {record.attributes.evidenceDocument?.data?.attributes?.currentVersion?.data?.attributes
                      ?.file?.data && (
                      <a
                        href={
                          record.attributes.evidenceDocument.data.attributes.currentVersion.data.attributes
          ...
          <Card className="mb-8 bg-brand-deep/5 border-brand-deep/20">
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-medium text-charcoal mb-1">Supply Chain Transparency</h3>
